...
RUN set -ex; \
    ...
    apt -y install git intltool closure-compiler python3-pip dumb-init iputils-ping dnsutils bash jq net-tools openvpn curl ufw p7zip-full unrar unzip wget tox && \
    #pip3 install --use-pep517 --user tox && \
